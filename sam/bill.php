...
<body>
   ...
   <div>
    ...
    <table>
        ...
        <div class="pname">
         <b>No. of Connection :- </b><?php echo $row['water_conn'];?> &nbsp; <b>Water bill :- </b><?php echo $rows['Water_bill'];?>
        </div>
        ...
        <div class="pname">  
         <b>Area of land  :- </b><?php echo $row['area'];?> <b>Sqrt</b>&nbsp;<b>Land bill :- </b><?php echo $rows['land_bill'];?> 
        </div> 
